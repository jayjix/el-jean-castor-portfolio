...
class Portfolio {
    ...
    handleNavbarScroll() {
        ...
        if (window.scrollY > 50) {
            ...
            navbar.style.boxShadow = '0 2px 20px rgba(139, 71, 137, 0.15)';
        } else {
            navbar.style.background = document.body.classList.contains('dark') 
                ? 'rgba(26, 15, 31, 0.95)' 
    ...
    showNotification(message, type = 'info') {
        ...
        notification.style.cssText = `
            ...
            top: 100px;
            right: 20px;
            background: ${type === 'success' ? '#9B59B6' : type === 'error' ? '#EF4444' : '#8B4789'};
            color: white;
            padding: 1rem 1.5rem;
    ...
    initEasterEgg() {
        ...
        document.addEventListener('keydown', (e) => {
            ...
            if (JSON.stringify(userInput) === JSON.stringify(konamiCode)) {
                this.showNotification('🎮 Konami Code activated! El-Jean would be proud! 🎮', 'success');
                this.addGameEffect();
                userInput = [];
            }
        });
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log(
        ...
        'color: #8B4789; font-size: 20px; font-weight: bold;'
    );
    console.log(
        '%cThis portfolio was built by El-Jean Castor\n' +
        'BSIT 2nd Year Student at STII\n' +
        'Contact: eljeancastor57@gmail.com\n' +
        'Instagram: @jnzn.jinggggg',
        'color: #B565A7; font-size: 14px;'
    );
    console.log(
        '%cTry the Konami Code for a surprise! ⬆️⬆️⬇️⬇️⬅️➡️⬅️➡️BA',
        'color: #D8A7D8; font-size: 12px; font-style: italic;'
    );
});
